...
def ask_gpt(prompt):
    ...
    if USE_LOCAL_LLM:
        try:
            print(f"Sending request to GPT at url: {LOCAL_LLM_API_URL}")
        ...
        try:
            ...
            return None
# Added wrapper for compatibility with trading bot and CLI.
def get_account_overview(prompt):
    """
    Wrapper function to obtain an account overview or trading advice.
    """
