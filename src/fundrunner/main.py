...
class CLI:
    ...
    def view_order_history(self):
        ...
        try:
            from fundrunner.utils.transaction_logger import read_transactions
    ...
    def get_trading_advice(self):
        ...
        try:
            from fundrunner.bots.chatgpt_advisor import get_account_overview
    ...
    def launch_watchlist_view(self):
        try:
            from fundrunner.utils.watchlist_view import main as watchlist_view_main
